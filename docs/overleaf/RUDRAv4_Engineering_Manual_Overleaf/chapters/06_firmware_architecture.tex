...
This is important. The telemetry firmware is backward-compatible with the ROS bridge because the NUC already drains Teensy serial lines and routes telemetry lines to \topic{/rudra/imu_raw} and \topic{/rudra/wheel_odom}. Non-telemetry lines remain available as \topic{/rudra/teensy_ack}.
