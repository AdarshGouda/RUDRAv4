...
PS2 + LiDAR + localization + DCDC & Full robot bringup with NUC power diagnostics & \cmd{ros2 launch rudra_base_bridge rudra_ps2_lidar_localization.launch.py enable_dcdc_monitor:=true}\\
...
With the DCDC-USB powering the NUC, use the same launch file with the monitor enabled:
